    ...
    if ($this->tracking_option == "BOTH" && $this->gm_id && $this->ga_id) { ?>
      ...
      <script data-cfasync="false" data-no-optimize="1" data-pagespeed-no-defer>
        ...
        gtag("config", "<?php echo esc_js($this->gm_id); ?>", {
          <?php echo $ga_ip_anonymization; ?> "cookie_domain": "<?php echo esc_js($this->ga_Dname); ?>",
          <?php if ($this->ga_CG) {
...
class Con_GTM_Tracking extends Con_Settings
{
  ...
  public function product_thankyou_view($order_id = null)
  {
    ...
    $ee_sst_pcount = (int)get_option('ee_sst_pcount', 0);
    $ee_sst_pcount_new = $ee_sst_pcount + 1;
    update_option('ee_sst_pcount', $ee_sst_pcount_new);
