 ...
 * @author     Tatvic
 */
class Enhanced_Ecommerce_Google_Analytics_Pro
{
  ...
  private function load_dependencies()
  {
    ...
    require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-conversios-pro-updater.php';
    /**
  ...
  public function run()
  {
    if (is_plugin_active_for_network('woocommerce/woocommerce.php') || in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
      ...
      if (is_plugin_active('woocommerce/woocommerce.php') || is_plugin_active_for_network('woocommerce/woocommerce.php')) {
        $this->loader->run();
      } else if (is_admin() && !is_network_admin() && is_plugin_active('enhanced-e-commerce-pro-for-woocommerce-store/enhanced-ecommerce-pro-google-analytics.php')) {
        $this->loader->run();
      }
    }
  }
