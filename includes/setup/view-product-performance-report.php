    ...
    {  ?>
        ...
        <div class="con-tab-content">
            <div class="tab-card">
                ...
                <table id="view_allproduct_reports" class="table table-striped table-hover table-responsive table-section" style="width:100%">
                    <thead class="table-primary">
                        <tr>
                            ...
                            <th>Added to Cart</th>
                            <th>Qty</th>
                            <th>Revenue (<span class="ga_currency_symbols"><?php echo esc_attr($this->ga_currency_symbols); ?></span>)</th>
