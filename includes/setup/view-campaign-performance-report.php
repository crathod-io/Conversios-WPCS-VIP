    ...
    {  ?>
        <div class="con-tab-content">
            <div class="tab-card">
                ...
                <table id="view_allcampaign_reports" class="table table-striped table-hover table-responsive table-section" style="width:100%">

                    <thead class="table-primary">
                        <tr>
                            <th>Campaign Name</th>
                            <th>Type</th>
                            <th>Daily Budget (<span class="ga_currency_symbols"><?php echo esc_attr($this->ga_currency_symbols); ?></span>)</th>
                            <th>Status</th>
                            <th>Clicks</th>
                            <th>Cost (<span class="ga_currency_symbols"><?php echo esc_attr($this->ga_currency_symbols); ?></span>)</th>
                            <th>Conversions</th>
                            <th>Sales</th>
                        </tr>
                    </thead>
