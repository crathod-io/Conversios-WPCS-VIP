              ...
              if (!isset($_GET['edit'])) { ?>
                <form method="post" id="create-form">
                  ...
                  <div class="form-row" style="margin-bottom: 0">
                    ...
                    <div class="col-md-12 row">
                      <label for="campaign-budget" class="form-group col-md-4 mt-2 mb-0 text-left"><span class="font-weight-bold"><?php esc_html_e("Daily Campaign Budget", "enhanced-e-commerce-for-woocommerce-store"); ?> (<?php echo  esc_attr($currency); ?>):</span>
                        <p style="text-align:left;font-size: 11px;"><?php esc_html_e("Only pay if someone clicks your ad. Recommended minimum budget of $5 per day.", "enhanced-e-commerce-for-woocommerce-store"); ?></p>
                      </label>
                      <input type="number" class="form-group col-md-6" name="campaign_budget" id="campaign-budget" style="height: 35px;" required>
                    </div>
                    <div class="col-md-12 row">
                      <label for="sales-country" class="form-group col-md-4 mt-2 text-left"><span class="font-weight-bold"><?php esc_html_e("Target Country:", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <p style="text-align:left;font-size: 11px;"><?php esc_html_e("If you want to target multiple countries, then create multiple campaigns.", "enhanced-e-commerce-for-woocommerce-store"); ?></p>
                      </label><?php echo  $this->country_dropdown(); ?>
                    </div>
                    <div class="col-md-12 row">
              ...
              <?php
                ...
                <form method="post">
                  ...
                  <div class="form-row" style="margin-bottom: 0">
                    ...
                    <div class="col-md-12 row">
                      <label for="campaign-budget" class="form-group col-md-4 mt-2 mb-0 text-left"><span class="font-weight-bold"><?php esc_html_e("Daily Campaign Budget", "enhanced-e-commerce-for-woocommerce-store"); ?> (<?php echo esc_attr($currency); ?>):</span>
                        <p style="text-align:left;font-size: 11px;"><?php esc_html_e("Only pay if someone clicks your ad. Recommended minimum budget of", "enhanced-e-commerce-for-woocommerce-store"); ?> <?php echo esc_attr($currency); ?>5 per day.</p>
                      </label>
