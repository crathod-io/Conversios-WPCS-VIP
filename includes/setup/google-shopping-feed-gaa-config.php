                ...
                <div class="google-account-analytics" id="gaa-config">
                  ...
                  if (isset($googleDetail->google_merchant_center_id) && esc_attr($googleDetail->google_merchant_center_id) != '') { ?>
                    <div class="row mb-3">
                      ...
                      <div class="col-6 col-md-6">
                        <button id="tvc_btn_product_sync" type="button" class="btn btn-primary btn-success" data-bs-toggle="modal" data-bs-target="#syncProduct">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-6 col-md-6">
                        <a href="admin.php?page=conversios-google-shopping-feed&tab=add_campaign_page" class="btn btn-primary btn-success" id="shopping_campaign">
                  ...
                  <form method="post" class="tvc-auto-product-sync-form">
                    ...
                    <div class="auto_product_sync_save_button mb-3">
                      <div class="col-12 col-md-12 col-lg-12">
                        <button type="submit" id="auto_product_sync_save" class="auto_product_sync_save btn btn-primary btn-success" name="auto_product_sync_setting_save">
