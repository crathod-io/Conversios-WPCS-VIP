          ...
          <div class="row">
            <div class="col-md-6 col-lg-8 edit-section">
              <?php if ($this->subscriptionId != "") { ?>
                <div class="tvc-api-sunc">
                  ...
                  </span><span id="products_count"></span><img id="refresh_api" onclick="call_tvc_api_sync_up();"
                    src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/refresh.png'); ?>">
                </div>
              <?php } ?>
              ...
              <div class="mt-3" id="config-pt2">
                <div class="google-account-analytics" id="gaa-config">
                  <div class="row mb-3">
                    <div class="col-6 col-md-6 col-lg-6">
                      <h2 class="ga-title">
                        <?php esc_html_e("Connected Google Merchant center account:", "enhanced-e-commerce-for-woocommerce-store"); ?>
                      </h2>
                    </div>
                    <div class="col-6 col-md-6 col-lg-6 text-right">
                      <div class="acc-num">
                        <p class="ga-text">
                          <?php echo ((isset($googleDetail->google_merchant_center_id) && esc_attr($googleDetail->google_merchant_center_id) != '') ? esc_attr($googleDetail->google_merchant_center_id) : '<span>' . esc_html__('Get started', 'enhanced-e-commerce-for-woocommerce-store') . '</span>'); ?>
                        </p>
                        <?php
                  ...
                  <div class="row mb-3">
                    <div class="col-6 col-md-6 col-lg-6">
                      <h2 class="ga-title">
                        <?php esc_html_e("Linked Google Ads Account:", "enhanced-e-commerce-for-woocommerce-store"); ?>
                      </h2>
                    </div>
                    <div class="col-6 col-md-6 col-lg-6 text-right">
                      <div class="acc-num">
                        <p class="ga-text">
                          <?php echo (isset($googleDetail->google_ads_id) && esc_attr($googleDetail->google_ads_id) != '' ? esc_attr($googleDetail->google_ads_id) : '<span>' . esc_html__('Get started', 'enhanced-e-commerce-for-woocommerce-store') . '</span>'); ?>
                        </p>
                        <?php
                  ...
                  if (isset($googleDetail->google_merchant_center_id) && esc_attr($googleDetail->google_merchant_center_id) != '') { ?>
                    <div class="row mb-3">
                      <div class="col-6 col-md-6">
                        <h2 class="ga-title">
                          <?php esc_html_e("Sync Products:", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h2>
                      </div>
                      <div class="col-6 col-md-6">
                        <button id="tvc_btn_product_sync" type="button" class="btn btn-primary btn-success"
                          data-bs-toggle="modal" data-bs-target="#syncProduct">
                          <?php esc_html_e("Sync New Products", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </button>
                      </div>
                    </div>
                    <div class="row mb-3">
                      <div class="col-6 col-md-6">
                        <h2 class="ga-title">
                          <?php esc_html_e("Smart Shopping Campaigns:", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h2>
                      </div>
                      <div class="col-6 col-md-6">
                        <a href="admin.php?page=conversios-google-shopping-feed&tab=add_campaign_page"
                          class="btn btn-primary btn-success" id="shopping_campaign">
                          <?php esc_html_e("Create Smart Shopping Campaign", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </a>
                      </div>
                    </div>
                  <?php } else { ?>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-6 col-md-6">
                        <a href="<?php echo esc_url_raw($this->url); ?>" class="btn btn-primary btn-success "
                          id="shopping_campaign"><?php esc_html_e("Create Smart Shopping Campaign", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                      </div>
                    </div>
                  <?php } ?>
                  <?php if ($this->plan_id != 1) { ?>
                    <form method="post" class="tvc-auto-product-sync-form">
                      <div class="row mb-3">
                        <div class="col-6 col-md-6 col-lg-6">
                          <h2 class="ga-title">
                            <?php esc_html_e("Select time interval for product sync", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            <div class="tvc-tooltip tvc-product-sync-toolip">
                              <span class="tvc-tooltiptext tvc-tooltip-right">
                                <?php esc_html_e("This will periodically sync your products in the google merchant center as it is important to keep your store products updated in the merchant center if you are running shopping ads. By default the products will get sync after every 25 days.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                              </span>
                              <img
                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/icon/informationI.svg"); ?>"
                                alt="" />
                            </div>
                            <span class="tvc-pro">: (PRO)</span>
                          </h2>
                        </div>
                        <div class="col-6 col-md-6 col-lg-6 text-right">
                          <input id="pro_snyc_time_limit" name="pro_snyc_time_limit"
                            value="<?php echo esc_attr($pro_snyc_time_limit); ?>" class="pro_snyc_time_limit" type="number"
                            min="1" max="28">
                          <select name="product_sync_duration" class="product_sync_duration">
                            <option value="Day" <?php echo esc_attr($product_sync_duration) == 'Day' ? 'selected' : '' ?>>Day
                            </option>
                            <option value="hour" <?php echo esc_attr($product_sync_duration) == 'hour' ? 'selected' : '' ?>>Hour
                            </option>
                          </select>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-6 col-md-6 col-lg-6">
                          <h2 class="ga-title">
                            <?php esc_html_e("Select product sync batch size", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            <div class="tvc-tooltip tvc-product-sync-toolip">
                              <span class="tvc-tooltiptext tvc-tooltip-right">
                                <?php esc_html_e("The product sync will happen based on the batch size you select. By default the batch size is 50 products per batch. This should be set up based on your server configuration in order to manage your site performance.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                              </span>
                              <img
                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/icon/informationI.svg"); ?>"
                                alt="" />
                        ...
                        <div class="col-6 col-md-6 col-lg-6 text-right">
                          <select name="product_sync_batch_size" class="product_sync_batch_size">
                            ...
                            <option value="10" <?php echo esc_attr($product_sync_batch_size) == '10' ? 'selected' : '' ?>>10
                            </option>
                            <option value="25" <?php echo esc_attr($product_sync_batch_size) == '25' ? 'selected' : '' ?>>25
                            </option>
                            <option value="50" <?php echo esc_attr($product_sync_batch_size) == '50' ? 'selected' : '' ?>>50
                            </option>
                            <option value="100" <?php echo esc_attr($product_sync_batch_size) == '100' ? 'selected' : '' ?>>100
                            </option>
                            <option value="500" <?php echo esc_attr($product_sync_batch_size) == '500' ? 'selected' : '' ?>>500
                            </option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="auto_product_sync_save_button mb-3">
                        <div class="col-12 col-md-12 col-lg-12">
                          <button type="submit" id="auto_product_sync_save"
                            class="auto_product_sync_save btn btn-primary btn-success" name="auto_product_sync_setting_save">
                  ...
                  <?php } else { ?>
                    ...
                    <div class="row">
                      <div class="col-6 col-md-6 col-lg-6">
                        <h2 class="ga-title">
                          <?php esc_html_e("Select time interval for product sync:", "enhanced-e-commerce-for-woocommerce-store"); ?><span
                            class="tvc-pro"> (PRO)</span>
                        </h2>
                      </div>
                    ...
                    <div class="row ">
                      <div class="col-6 col-md-6 col-lg-6">
                        <h2 class="ga-title">
                          <?php esc_html_e("Select product sync batch size:", "enhanced-e-commerce-for-woocommerce-store"); ?><span
                            class="tvc-pro"> (PRO)</span>
                        </h2>
                      </div>
                      <div class="col-6 col-md-6 col-lg-6 mt-2">
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <div class="tvc-youtube-video">
                ...
                <a href="https://www.youtube.com/watch?v=_C9cemX6jCM" target="_blank">Walkthrough about Smart Shopping
                  Campaign</a>
              </div>
            </div>
          </div>
