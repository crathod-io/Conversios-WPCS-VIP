...
if (!class_exists('Conversios_Analytics_Reports')) {
  class Conversios_Analytics_Reports
  {
    ...
    public function __construct()
    {
      ...
      if($this->ga_swatch == "ga3"){
        wp_redirect("admin.php?page=conversios-analytics-reports&ga_type=ga4");
        exit;
      }
      ...
      if ($this->subscription_id != "") {
        ...
        $this->sch_email_toggle_check = isset($this->ee_options['sch_email_toggle_check']) ? sanitize_text_field($this->ee_options['sch_email_toggle_check']) : '1';
        $this->sch_custom_email = isset($this->ee_options['sch_custom_email']) ? sanitize_text_field($this->ee_options['sch_custom_email']) : '';
        $this->sch_email_frequency = isset($this->ee_options['sch_email_frequency']) ? sanitize_text_field($this->ee_options['sch_email_frequency']) : '';
    ...
    public function load_html()
    {
      ...
      if ($this->google_ads_id != null || $this->ga4_measurement_id != null) {
        $this->current_html();
        $this->current_js();
      } else {
?>
...
jQuery(document).ready(function() {
    ...
    jQuery('#email_toggle_btn').change(function() {
        if (jQuery(this).prop("checked")) {
            ...
            jQuery("#custom_email").val('<?php echo $this->g_mail; ?>');
    ...
    <div class="dflex align-items-center mt24 dshbrdtoparea">
        <div class="ga_swatch">
            ...
            <span class="<?php echo esc_attr($this->ga_swatch == "ga4") ? "active" : ""; ?>" id="ga4"><a
                    href="<?php echo esc_url_raw($current_page . "&ga_type=ga4"); ?>">GA4</a></span>
            <?php } ?>
        </div>
...
<div class="mt24 dshchrtwrp ecomfunnchart">
    <div class="row">
        ...
        <div class="col50">
            <div class="chartbx ecomfunnchrtbx">
                <div class="chartcntnbx prochrtftr">
                    <h5><?php esc_html_e("Ecommerce Checkout Funnel", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </h5>
                    <div class="chartarea">
                        <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/ecom-chart.jpg'); ?>"
                            alt="" />
                ...
                <div class="prochrtovrbox">
                    <div class="prochrtcntn">
                        ...
                        <h5 class="prochrtitle">
                            <?php esc_html_e("Checkout Funnel", "enhanced-e-commerce-for-woocommerce-store"); ?></h5>
                        <p><?php esc_html_e("This Report will help you visualize drop offs at each stage of your checkout funnel starting from view carts to begin checkout, add shipping info to add payment info and to final purchase. Find out the major drop offs at each stage and take informed data driven decisions to increase the conversions and better marketing ROI.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </p>
                        <a class="blueupgrdbtn" href="<?php echo esc_url_raw($this->pro_plan_site); ?>"
                            target="_blank"><?php esc_html_e("Upgrade Now", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                    </div>
...
<div class="mt24 whiteroundedbx dshreport-sec">
    <div class="row dsh-reprttop">
        <div class="col">
            <div class="chartbx ecomfunnchrtbx">
                <div class="chartcntnbx prochrtftr">
                    <h5><?php esc_html_e("Ecommerce Checkout Funnel Report", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </h5>
                    <div class="chartarea">
                ...
                <div class="prochrtovrbox">
                    <div class="prochrtcntn">
                        ...
                        <h5 class="prochrtitle">
                            <?php esc_html_e("Ecommerce Checkout Funnel Report", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
                        <p><?php esc_html_e("This report will provide valuable insights into the effectiveness of sales efforts, highlighting key metrics and trends to optimize revenue generation and drive business growth.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </p>
                        <a class="blueupgrdbtn" href="<?php echo esc_url_raw($this->pro_plan_site); ?>"
                            target="_blank"><?php esc_html_e("Upgrade Now", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                    </div>
...
<div class="mt24 whiteroundedbx dshreport-sec">
    <div class="row dsh-reprttop">
        <div class="dshrprttp-left">
            ...
            <a href="admin.php?page=conversios-analytics-reports&tab=order-performance-report"
                class="viewallbtn"><?php esc_html_e("View all", "enhanced-e-commerce-for-woocommerce-store"); ?> <img
...
<div class="mt24 whiteroundedbx dshreport-sec">
    <div class="row dsh-reprttop">
        <div class="col">
            <div class="chartbx ecomfunnchrtbx">
                <div class="chartcntnbx prochrtftr">
                    <h5><?php esc_html_e("Order Performance Report", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </h5>
                    <div class="chartarea">
                        <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/table-data.jpg'); ?>"
                            alt="" />
                ...
                <div class="prochrtovrbox">
                    <div class="prochrtcntn">
                        ...
                        <h5 class="prochrtitle">
                            <?php esc_html_e("Order Performance Report", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
                        <p><?php esc_html_e("This report will provide valuable insights into the effectiveness of sales efforts, highlighting key metrics and trends to optimize revenue generation and drive business growth.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </p>
                        <a class="blueupgrdbtn" href="<?php echo esc_url_raw($this->pro_plan_site); ?>"
...
<div class="mt24 whiteroundedbx dshreport-sec">
    <div class="row dsh-reprttop">
        <div class="dshrprttp-left">
            ...
            <a href="admin.php?page=conversios-analytics-reports&tab=product-performance-report"
                class="viewallbtn"><?php esc_html_e("View all", "enhanced-e-commerce-for-woocommerce-store"); ?> <img
                    src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/blue-right-arrow.png'); ?>"
                    alt="" /></a>
        </div>
...
<div class="mt24 whiteroundedbx dshreport-sec">
    <div class="row dsh-reprttop">
        <div class="col">
            <div class="chartbx ecomfunnchrtbx">
                <div class="chartcntnbx prochrtftr">
                    <h5><?php esc_html_e("Product Performance Report", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </h5>
                    <div class="chartarea">
                        <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/table-data.jpg'); ?>"
                            alt="" />
                ...
                <div class="prochrtovrbox">
                    <div class="prochrtcntn">
                        ...
                        <h5 class="prochrtitle">
                            <?php esc_html_e("Product Performance Report", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
...
<div class="mt24 whiteroundedbx dshreport-sec">
    <div class="row dsh-reprttop">
        <div class="dshrprttp-left">
            ...
            <a href="admin.php?page=conversios-analytics-reports&tab=source-performance-report"
                class="viewallbtn"><?php esc_html_e("View all", "enhanced-e-commerce-for-woocommerce-store"); ?> <img
                    src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/blue-right-arrow.png'); ?>"
                    alt="" /></a>
        </div>
...
<div class="mt24 whiteroundedbx dshreport-sec">
    <div class="row dsh-reprttop">
        <div class="col">
            <div class="chartbx ecomfunnchrtbx">
                <div class="chartcntnbx prochrtftr">
                    <h5><?php esc_html_e("Source/Medium Performance Report", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </h5>
                    <div class="chartarea">
                        <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/table-data.jpg'); ?>"
                            alt="" />
...
<div class="mt24 whiteroundedbx dshreport-sec">
    <div class="row dsh-reprttop">
        <div class="dshrprttp-left">
            ...
            <a href="admin.php?page=conversios-analytics-reports&tab=campaign-performance-report"
                class="viewallbtn"><?php esc_html_e("View all", "enhanced-e-commerce-for-woocommerce-store"); ?> <img
                    src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/blue-right-arrow.png'); ?>"
                    alt="" /></a>
        </div>
            ...
            <div class="chartbx ecomfunnchrtbx">
                ...
                <div class="prochrtovrbox">
                    <div class="prochrtcntn">
                        ...
                        <h5 class="prochrtitle">
                            <?php esc_html_e("Campaign Performance", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
                        <p><?php esc_html_e("Access your campaign performance data to know how are they performing and take actionable decisions to increase your marketing ROI.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </p>
                        <a class="blueupgrdbtn" href="<?php echo esc_url_raw($this->pro_plan_site); ?>"
                            target="_blank"><?php esc_html_e("Upgrade Now", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                    </div>
            ...
            <div class="modal-body">
                <div class="scheduleemail-box">
                    ...
                    if ($this->sch_email_toggle_check == '0') { //enabled
                      ...
                      if ($this->sch_custom_email != '') {
                        $sch_custom_email_final = $this->sch_custom_email;
                      } else {
                        $sch_custom_email_final = $this->g_mail;
                      }
                    ...
                    <div class="schedule-formbox">
                            ...
                            <div class="form-check form-switch">
                                <div class="form-check form-switch">
                                    <label id="email_toggle_btnLabel" for="email_toggle_btn"
                                        class="form-check-input switch <?php echo $switch_cls; ?>" role="switch">
                                        <input id="email_toggle_btn" type="checkbox" class="<?php echo $switch_cls; ?>"
                                            <?php echo $switch_checked; ?>>
                                        <div></div>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-wholebox">
                            <div class="form-box">
                                ...
                                <input type="email" class="form-control icontrol" id="custom_email"
                                    aria-describedby="emailHelp" placeholder="user@gmail.com"
                                    value="<?php echo $sch_custom_email_final; ?>"
                                    <?php echo $email_frequency_disabled; ?>>
                            </div>
                            <div class="form-box">
                                ...
                                <input type="text" class="form-control icontrol" id="email_frequency"
                                    value="<?php echo $this->sch_email_frequency; ?>"
                                    <?php echo $email_frequency_disabled; ?> readonly>
                            ...
                            <?php
                        if ($this->sch_email_frequency == "Daily") {
                          $sch_duration = "day";
                          $sch_duration_days = "7";
                        } else if ($this->sch_email_frequency == "Weekly") {
                          $sch_duration = "week";
                          $sch_duration_days = "7";
                        } else if ($this->sch_email_frequency == "Monthly") {
                          $sch_duration = "month";
                            ...
                            <div class="form-box">
                                <div class="save">
                                    <button id="schedule_email_save_config"
                                        class="btn  save-btn"><?php echo $save_btn_text; ?></button>
                                </div>
                            </div>
                            <div class="form-box">
                                <div class="save">
...
<div class=" custom-toast position-fixed bottom-0 end-0 p-3" style="z-index: 11;">
    <div id="sch_ack_msg" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true">
        <button id="sch_ack_msg_close" type="button" class="btn-close" data-bs-dismiss="toast"
