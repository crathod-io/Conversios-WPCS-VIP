...
if (!class_exists('Conversios_Onboarding_Helper')) :
  class Conversios_Onboarding_Helper
  {
    ...
    public function __construct()
    {
      ...
      add_action('wp_ajax_conv_get_gtm_account_list', [$this, 'conv_get_gtm_account_list']);
      add_action('wp_ajax_conv_get_gtm_container_list', [$this, 'conv_get_gtm_container_list']);
      add_action('wp_ajax_conv_create_gtm_container', [$this, 'conv_create_gtm_container']);
      add_action('wp_ajax_conv_run_gtm_automation', [$this, 'conv_run_gtm_automation']);
      add_action('wp_ajax_conv_get_gtm_account_with_container', [$this, 'conv_get_gtm_account_with_container']);
      add_action('wp_ajax_conv_get_global_container_json', [$this, 'conv_get_global_container_json']);

      // SST Settings
      add_action('wp_ajax_conv_create_cloud_run', [$this, 'conv_create_cloud_run']);
    }
    ...
    public function conv_get_gtm_account_list()
    {
      ...
      if ($this->admin_safe_ajax_call($nonce, 'gtm_account_nonce')) {
        $customApiObj = new CustomApi();
        $data = $customApiObj->conv_get_gtm_account_list($_POST);
    ...
    public function conv_get_gtm_container_list()
    {

      $nonce = (isset($_POST['gtm_container_nonce'])) ? sanitize_text_field($_POST['gtm_container_nonce']) : "";
      if ($this->admin_safe_ajax_call($nonce, 'gtm_container_nonce')) {
        $customApiObj = new CustomApi();
        $data = $customApiObj->conv_get_gtm_container_list($_POST);

        unset($_POST['subscription_id']);
        unset($_POST['gtm_container_nonce']);
        echo json_encode($data);
        wp_die();
      } else {
        echo esc_html__("Admin security nonce is not verified.", "enhanced-e-commerce-for-woocommerce-store");
    ...
    public function conv_create_gtm_container()
    {

      $nonce = (isset($_POST['gtm_create_container_nonce'])) ? sanitize_text_field($_POST['gtm_create_container_nonce']) : "";
      if ($this->admin_safe_ajax_call($nonce, 'gtm_create_container_nonce')) {
        $customApiObj = new CustomApi();
        $data = $customApiObj->conv_create_gtm_container($_POST);
    ...
    public function conv_run_gtm_automation()
    {

      $nonce = (isset($_POST['gtm_run_gtm_automation_nonce'])) ? sanitize_text_field($_POST['gtm_run_gtm_automation_nonce']) : "";
      if ($this->admin_safe_ajax_call($nonce, 'gtm_run_gtm_automation_nonce')) {
        $customApiObj = new CustomApi();
        $data = $customApiObj->conv_run_gtm_automation($_POST);
    ...
    public function conv_get_gtm_account_with_container()
    {
      ...
      if ($this->admin_safe_ajax_call($nonce, 'get_gtm_account_with_container_nonce')) {
        $customApiObj = new CustomApi();
        $data = $customApiObj->conv_get_gtm_account_with_container($_POST);
    ...
    public function conv_get_global_container_json()
    {
      ...
      if ($this->admin_safe_ajax_call($nonce, 'gtm_global_container_json_nonce')) {
        $customApiObj = new CustomApi();
        $data = $customApiObj->conv_get_global_container_json($_POST);
    ...
    public function conv_create_cloud_run()
    {

      $nonce = (isset($_POST['create_cloud_nonce'])) ? sanitize_text_field($_POST['create_cloud_nonce']) : "";
      if ($this->admin_safe_ajax_call($nonce, 'create_cloud_nonce')) {
        $customApiObj = new CustomApi();
        $data = $customApiObj->conv_create_cloud_run($_POST);
