...
if (class_exists('Conversios_Dashboard_Helper') === FALSE) {
	...
	class Conversios_Dashboard_Helper
	{
		...
		public function __construct()
		{
			...
			add_action('wp_ajax_get_google_ads_campaign_performance_dashboard', array($this, 'get_google_ads_campaign_performance_dashboard'));
		}
		...
		public function get_google_ads_campaign_performance_dashboard()
		{
