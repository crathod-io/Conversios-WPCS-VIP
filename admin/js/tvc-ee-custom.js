...
var tvc_helper = {
  ...
  set_google_analytics_reports_value: function (data, post_data) {
    ...
    if (Object.keys(s_1_div_id).length > 0) {
      ...
      (reports_typs.product_performance_report.is_free || paln_type == "paid")
    ) {
      var p_p_r = data.product_performance_report.products;
      //console.log(p_p_r);
      var table_row = "";
    ...
    if (
      ...
      (reports_typs.medium_performance_report.is_free || paln_type == "paid")
    ) {
  ...
  get_analytics_reports_section: function () {
    return {
      ...
      checkout_funnel_report: {
        "loading-type": "gif",
        "main-class": "checkout_funnel_report",
      },
