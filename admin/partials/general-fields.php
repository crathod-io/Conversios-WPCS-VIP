  ...
  <div class="row justify-content-center" style="--bs-gutter-x: 0rem;">
    ...
    <div class="convfixedcontainermid col-md-8 col-xs-12 m-0 p-0">
        ...
        <div class="convcard d-flex flex-row p-2 mt-0 rounded-3 shadow-sm">
          <div class="convcard-left conv-pixel-logo">
            <div class="convcard-logo text-center p-2 pe-3 border-end">
              <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_gtm_logo.png'); ?>" />
            </div>
          </div>
          <div class="convcard-center p-2 ps-3 col-10">
            <div class="convcard-title">
              <h3 class="d-flex">Google Tag Manager (GTM)
                <?php if ($is_sst_gtm_connected == "") { ?>
                  <span class="badge rounded-pill conv-badge ms-auto align-self-center <?php echo (empty($subscription_id) || $tracking_method != "gtm") ? "conv-badge-yellow" : "conv-badge-green"; ?>">
                    <?php echo (empty($subscription_id) || $tracking_method != "gtm") ? "Mandatory" : "Connected"; ?>
                  </span>
                <?php } ?>
              </h3>
              <span>
                <?php
                if ($is_sst_gtm_connected == "") {
                  echo esc_attr($use_your_gtm_id);
                }
                ?>
              </span>
              <hr>
              <div class="d-flex">
                <span>
                  <?php esc_html_e("How to set up your own GTM container using conversios plugin?", "enhanced-e-commerce-for-woocommerce-store"); ?>
              ...
              <div class="d-flex mt-3">
                <span>
                  <?php esc_html_e("Benefits of using your own GTM container.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                  <a target="_blank" class="conv-link-blue conv-watch-video" href="https://www.conversios.io/docs/what-are-the-advantages-of-gtm-based-implementation-vs-on-page-implementation/?utm_source=gtm_inapp&utm_medium=resource_center_list&utm_campaign=resource_center">
          ...
          <div class="convcard-right ms-auto">
            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage="gtmsettings"'); ?>" class="h-100 rounded-end d-flex justify-content-center convcard-right-arrow link-dark">
      ...
      <div class="convo_sst convcard d-flex flex-row  mt-3">
        ...
        <div class="convcard-right ms-auto">
          <?php if ($plan_id == 41 || $plan_id == 42 || $plan_id == 1) { ?>
      ...
      <div class="pt-4 conv-heading-box">
        <h3>INTEGRATIONS</h3>
        <span>Once you’ve finished setting up your Google Tag Manager (GTM), go ahead with pixels & other integrations.</span>
      </div>
        ...
        <div class="convcard conv-pixel-list-item d-flex flex-row p-2 mt-0 border-top <?php echo $conv_gtm_not_connected; ?>">
          ...
          <div class="p-1 ps-3 align-self-center">
            <span class="fw-bold m-0">
              ...
              <a target="_blank" class="conv-link-blue conv-watch-video ps-2 fw-normal invisible" href="<?php echo esc_url($pixel_video_link['twitter_ads_pixel_id']); ?>">
                <span class="material-symbols-outlined align-text-bottom">play_circle_outline</span>
                <?php esc_html_e("Watch here", "enhanced-e-commerce-for-woocommerce-store"); ?>
              </a>
            </span>
      ...
      <?php if (is_plugin_active_for_network('woocommerce/woocommerce.php') || in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) { ?>
        <div class="pt-4 conv-heading-box">
          ...
          <span>This feature is for the woocommerce store which has changed standard woocommerce hooks or implemented custom woocommerce hooks.</span>
        </div>
