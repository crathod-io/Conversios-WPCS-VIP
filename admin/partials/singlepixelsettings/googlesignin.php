    ...
    <?php } else { ?>
        ...
        <div class="tvc_google_signinbtn_box" style="width: 185px;">
            <div class="tvc_google_signinbtn google-btn">
                ...
                <p class="btn-text"><b>
                        <?php esc_html_e("Sign in with google", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </b></p>
            </div>
        </div>
    <?php } ?>
        ...
        <div class="onbrdnpp-cntner acccretppcntnr">
            <div class="onbrdnpp-hdr">
                <div class="ppclsbtn clsbtntrgr"><img
                        src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/close-icon.png'); ?>" alt="" />
                </div>
            </div>
                        ...
                        <?php } else { ?>
                            <div class="google_connect_url google-btn">
                                ...
                                <p class="btn-text mr-35"><b>
                                        <?php esc_html_e("Reauthorize", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                    </b></p>
                            </div>
                        <?php } ?>
                    <?php } ?>
