...
<div class="convcard p-4 mt-0 rounded-3 shadow-sm">
    ...
    <form id="gmcsetings_form" class="convpixsetting-inner-box mt-4">
        <div id="analytics_box_UA" class="py-1">
            ...
            <div class="row pt-2 conv-gmcsettings">
                ...
                <div class="col-2 conv-enable-selection conv-link-blue conv-enable-selection ">
            ...
            <div class="col-12 flex-row pt-3 row">
                ...
                <div class="col-6">
                    <?php
                    if (isset($is_site_verified) && $is_site_verified == 1) { ?>
                        <span class="material-symbols-outlined text-success fs-5" style="cursor:default">
                            check_circle
                        </span>
                    <?php } else { ?>
                        <span class="material-symbols-outlined text-danger fs-5" onclick="call_site_verified()"
            ...
            <div class="col-12 flex-row pt-3 row">
                ...
                <div class="col-6">
                    ...
                    <?php } else { ?>
                        <span class="material-symbols-outlined text-danger fs-5" onclick="call_domain_claim()"
                            style="cursor:pointer">
                            sync_problem
                        </span>
                    <?php }
    ...
    <input type="hidden" id="ads-account" value="<?php echo $google_ads_id; ?>" />
                ...
                <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check mb-4">
                                        ...
                                        <label class="form-check-label" for="concent">
                                            ...
                                            <a target="_blank"
                                                href="<?php echo esc_url_raw("https://support.google.com/merchants/answer/160173?hl=en"); ?>"><?php esc_html_e("terms & conditions", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                        </label>
                                    </div>
                    ...
                    <div class="col-5 ps-4 border-start">
                        <div>
                            ...
                            <ul class="p-0">
                                <li><a target="_blank"
                                        href="<?php echo esc_url_raw("https://support.google.com/merchants/answer/6149970?hl=en"); ?>"><?php esc_html_e("Google Shopping ads policies", "enhanced-e-commerce-for-woocommerce-store"); ?></a></li>
                                <li><a target="_blank"
                                        href="<?php echo esc_url_raw("https://support.google.com/merchants/answer/6150127"); ?>"><?php esc_html_e("Accurate Contact Information", "enhanced-e-commerce-for-woocommerce-store"); ?></a></li>
                                <li><a target="_blank"
                                        href="<?php echo esc_url_raw("https://support.google.com/merchants/answer/6150122"); ?>"><?php esc_html_e("Secure collection of process and personal data", "enhanced-e-commerce-for-woocommerce-store"); ?></a></li>
                                <li><a target="_blank"
                                        href="<?php echo esc_url_raw("https://support.google.com/merchants/answer/6150127"); ?>"><?php esc_html_e("Return Policy", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                </li>
                                <li><a target="_blank"
                                        href="<?php echo esc_url_raw("https://support.google.com/merchants/answer/6150127"); ?>"><?php esc_html_e("Billing terms & conditions", "enhanced-e-commerce-for-woocommerce-store"); ?></a></li>
                                <li><a target="_blank"
                                        href="<?php echo esc_url_raw("https://support.google.com/merchants/answer/6150118"); ?>"><?php esc_html_e("Complete checkout process", "enhanced-e-commerce-for-woocommerce-store"); ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="conv_save_success_modal_" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 pb-4 mb-1">
                <button id="modal_redirect" class="btn conv-blue-bg m-auto text-white" data-bs-dismiss="modal">Ok,
                    Done</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-4">
                <div class="connected-content">
                    ...
                    <p><span class="fw-bolder">Google Merchant Center Account -</span> <span
                            class="gmcAccount fw-bolder"></span>
                        Has Been Successfully Connected</p>
                    <p class="my-3">
                        <?php esc_html_e("By this step you have expanded your product presence on Google Search, Google
                        Shopping,
                        Google Images, YouTube, Google Maps, and more, you're maximizing your reach and unlocking new
                        potential for increased visibility and sales.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </p>
                </div>
                <div>
                            ...
                            <!-- <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                                <div class="attribute-box mb-3">
                                    ...
                                    <div class="attribute-content">
                                        ...
                                        <p>
                                        <?php esc_html_e("Proper attribute and category mapping for product feed ensures accurate
                                            product classification, improving search relevance and enhancing the overall
                                            shopping experience for users.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                        </p>
                                        <div class="attribute-btn">
                                            <a href="admin.php?page=conversios-google-shopping-feed&tab=product_mapping"
                                                class="btn btn-dark common-btn"><?php esc_html_e("Go To Attribute Mapping", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
...
<script>
    ...
    function save_merchant_data(google_merchant_center_id, merchant_id, tvc_data, subscription_id, plan_id, is_skip = fals) {
        if (google_merchant_center_id || is_skip == true) {
            ...
            var customer_id = "<?php echo $googleDetail->customer_id; ?>";
            var data = {
    ...
    function call_site_verified() {
        ...
        jQuery.post(tvc_ajax_url, {
            ...
            user_tracking_data('refresh_call', 'null', 'product-feed-manager-for-woocommerce', 'call_site_verified');
        });
    }
    ...
    jQuery(function () {
        ...
        //     jQuery(".conv-btn-connect").removeClass("conv-btn-connect-disabled");
        //     jQuery(".conv-btn-connect").addClass("conv-btn-disconnect");
        ...
        jQuery(".conv-enable-selection").click(function () {
            ...
            var selele = jQuery(".conv-enable-selection").closest(".conv-gmcsettings").find("select.google_merchant_center_id");
            var currele = jQuery(this).closest(".conv-gmcsettings").find("select.google_merchant_center_id");
        ...
        <?php if ((isset($_GET['subscription_id']) && sanitize_text_field($_GET['subscription_id'])) || (empty($google_merchant_center_id) && !empty($cust_g_email))) { ?>
        ...
        jQuery(document).on("click", ".conv-btn-connect-enabled-gmc", function () {
            ...
            if (selected_vals["google_merchant_center_id"] === '') {
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == "0" || response == "1") {
                        ...
                        jQuery('.gmcAccount').html(selected_vals["google_merchant_center_id"])
        ...
        jQuery("#create_merchant_account_new").on("click", function () {
            ...
            if (is_valide == true) {
                var data = {
                    ...
                    tvc_data: tvc_data,
                    conversios_onboarding_nonce: "<?php echo wp_create_nonce('conversios_onboarding_nonce'); ?>"
                };
                jQuery.ajax({
                    type: "POST",
                    dataType: "json",
