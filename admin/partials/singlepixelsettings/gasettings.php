                ...
                <div class="row pt-2">
                    <div class="col-7">
                        <h5 class="d-flex fw-normal mb-1 text-dark">
                            ...
                            ?>
                            <span class="material-symbols-outlined text-secondary md-18 ps-2" data-bs-toggle="tooltip" data-bs-placement="right" data-container="body" title="" data-bs-original-title="<?php esc_html_e($tooltip, "enhanced-e-commerce-for-woocommerce-store"); ?>">
                                <?php esc_html_e("info", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </span>
                        </h5>
                        <input type="text" name="ga4_api_secret" id="ga4_api_secret" class="form-control" value="<?php echo esc_attr($ga4_api_secret); ?>" placeholder="e.g. CnTrpcbsStWFU5-TmSuhuS">
                    </div>
...
<script>
                ...
                if (response && response.error == false) {
                    ...
                    if (response?.data?.items.length > 0) {
                        ...
                        getAlertMessageAll(
                            ...
                            buttonText = 'Ok',
                            buttonColor = '#FCCB1E',
                            iconImageSrc = '<img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_error_logo.png'); ?>"/ >'
                        );
                    }
    ...
    jQuery(function() {
        ...
        <?php if ((isset($_GET['subscription_id']) && sanitize_text_field($_GET['subscription_id'])) ||  ($cust_g_email != "" && empty($ga4_analytic_account_id)) ) { ?>
