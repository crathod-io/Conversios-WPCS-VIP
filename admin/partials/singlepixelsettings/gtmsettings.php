        ...
        success: function(response) {
          ...
          if (response.status == 200) {
            ...
            if (errors['subscription_id'] != undefined && errors['subscription_id'].length > 0) {
              ...
              // })
              getAlertMessage('error', 'Error', message = errors['subscription_id'][0], icon = 'error', buttonText = 'Try again', buttonColor = '#FCCB1E', iconImageSrc = '<img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_error_logo.png'); ?>"/ >')
            }
            // Swal.fire({
            //   icon: 'error',
            //   title: 'Oops...',
        ...
        jQuery.ajax({
          ...
          success: function(response) {
            ...
            if (response.status == 200) {
              ...
              getAlertMessage('error', 'Error', message = 'Conversios Container already exist in your account.', icon = 'error', buttonText = 'Try again', buttonColor = '#FCCB1E', iconImageSrc = '<img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_error_logo.png'); ?>"/ >')
            }
          }
        });
      ...
      jQuery.ajax({
        ...
        success: function(response) {
          ...
          if (response.status == 200) {
            ...
            getAlertMessage('error', 'Error', message = 'There is an issue in fetching GTM Account.', icon = 'error', buttonText = 'Try again', buttonColor = '#FCCB1E', iconImageSrc = '<img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_error_logo.png'); ?>"/ >')
