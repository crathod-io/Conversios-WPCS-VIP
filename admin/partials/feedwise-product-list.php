            ...
            <form id="feedForm" onfocus="this.className='focused'">
                ...
                <div class="modal-body ps-4 pt-0">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-7">
                            <input type="text" class="form-control-sm fs-14 " <?php echo ($plan_id === 1) ? 'readonly="readonly"' : ''; ?> name="autoSyncIntvl" id="autoSyncIntvl" size="3" min="1" onkeypress="return ( event.charCode === 8 || event.charCode === 0 || event.charCode === 13 || event.charCode === 96) ? null : event.charCode >= 48 && event.charCode <= 57" oninput="removeZero();" value="<?php echo (isset($conv_additional_data['pro_snyc_time_limit']) && $conv_additional_data['pro_snyc_time_limit'] > 0 && $plan_id !== 1) ? esc_html(sanitize_text_field($conv_additional_data['pro_snyc_time_limit'])) : "25"; ?>">
